...
*/
- (NSArray<NSString *> * _Nonnull)allCountries;
/**
...
*/
- (NSArray<NSString *> * _Nullable)countriesWithCode:(uint64_t)countryCode;
/**
...
*/
- (NSString * _Nullable)mainCountryForCode:(uint64_t)countryCode;
/**
...
*/
- (NSString * _Nullable)leadingDigitsFor:(NSString * _Nonnull)country;
/**
...
*/
+ (NSString * _Nonnull)defaultRegionCode;
@end
